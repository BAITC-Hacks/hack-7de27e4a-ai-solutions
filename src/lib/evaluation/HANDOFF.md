...
**Обновление 23 сентября 2026:** продвинутые функции, текущие команды, проверка
реального OpenAI и новые результаты описаны в [ADVANCED_HANDOFF.md](./ADVANCED_HANDOFF.md).
Ниже сохранена документация первоначального модуля C; её результаты относятся к
первой реализации, а не к текущему общему числу тестов.
...
Реальный OpenAI теперь проверен для strict review и HR-агента; результаты и ограничения
проверок приведены в ADVANCED_HANDOFF.md. Без ключа сохраняется fallback.
